...
const UsersByCountryWrapper = () => {
    return (  <div
        className=" w-full h-full flex flex-col rounded-xl"
        
      >
        <p className="pl-[22px] pt-3 font-inter font-bold text-base leading-[160%] tracking-[0.15px] text-[#eaeaff] opacity-[87%]">
          Users by Country
        </p>
...
export default UsersByCountryWrapper;