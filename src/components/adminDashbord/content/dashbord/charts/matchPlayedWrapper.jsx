...
const MatchPlayed = () => {
    ...
    return ( <div
        className="overflow-hidden   w-full h-full flex flex-col rounded-xl"
        
      >
        <p className="pl-5 pt-3 font-inter font-bold text-base leading-[160%] tracking-[0.15px] text-[#eaeaff] opacity-[87%]">
        Matches Played
        </p>
        <p className=" pl-5 text-[42px] font-inter font-bold leading-[123.5%] tracking-[0.25px] text-[#EAEAFF] opacity-[87%]" >200</p>
