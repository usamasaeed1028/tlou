...
const Layout = ({children}) => {
    ...
    <motion.div   className="w-full transition-all duration-150 ease-linear min-h-screen bg-black flex xl:gap-6 gap-5 pt-[34px] xl:pr-[3.5vw] pr-2 2xl:pr-[52px] pb-[30px] ">
       ...
       // layout transition={spring}
        ...
        className={` max-w-[262px]  rounded-[12px]   ${menuIsOpen?' lg:w-[19vw] md:w-[22vw] ':'w-fit   rounded-l-none   '}`}
        >
            <LeftNavBar/>
        </div>
        ...
        <motion.div  className="flex-grow flex flex-col gap-9  ">
                <div style={{background:'linear-gradient(97.77deg, rgba(30, 30, 30, 0.69) 1.14%, rgba(30, 30, 30, 0.5) 100%)',boxShadow:'inset 0px 0px 3px rgba(255, 255, 255, 0.31)',backdropFilter:'backdrop-filter: blur(28.5px)'}} 
