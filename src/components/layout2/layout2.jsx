...
if(width<1024) {
  ...
  return <div className="w-full h-screen items-center justify-center flex bg-black">
    <p className="text-white  text-4xl"> Please swich to a desktop to open this page </p>
  </div>
}
 ...
 */}    <motion.div className="w-full transition-all duration-150 ease-linear min-h-screen bg-black flex xl:gap-6 gap-5 pt-[34px] xl:pr-[3.5vw] pr-2 2xl:pr-[52px] pb-[30px] max- w-[1 440px] ">
      <div
        ...
        className={` max-w-[262px]  rounded-[12px]   ${
          menuIsOpen ? " lg:w-[19vw] md:w-[22vw] " : "w-fit   rounded-l-none   "
        }`}
      >
        <LeftNavBar />
      </div>
